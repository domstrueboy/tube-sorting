		    ...
		    <div class="modal-content">
				...
				<div class="input-group input-group-sm">
					...
					<div class="input-group-addon">Измерения
						<div class="form-inline input-group input-group-sm">
							<div class="input-group-addon">Угол левый</div>
							<input class="form-control" v-model.lazy="inputs.L" type="text">
							<div class="input-group-addon">градусов</div>
						</div>


						<div class="form-inline input-group input-group-sm">
							<div class="input-group-addon">Угол правый</div>
							<input v-model.lazy="inputs.R" type="text" class="form-control">
							<div class="input-group-addon">градусов</div>
						</div>

						<div class="form-inline input-group input-group-sm">
							<div class="input-group-addon">Угол центральный</div>
							<input v-model.lazy="inputs.C" type="text" class="form-control">
							<div class="input-group-addon">градусов</div>
						</div>

						<div class="form-inline input-group input-group-sm">
							<div class="input-group-addon">Расстояние от оси гиба до плоскости симметрии</div>
							<input v-model.lazy="inputs.A" type="text" class="form-control">
							<div class="input-group-addon">мм</div>
						</div>

						<div class="form-inline input-group input-group-sm">
							<div class="input-group-addon">Радиус левый</div>
							<input v-model.lazy="inputs.RL" type="text" class="form-control">
							<div class="input-group-addon">мм</div>
						</div>

						<div class="form-inline input-group input-group-sm">
							<div class="input-group-addon">Радиус правый</div>
							<input v-model.lazy="inputs.RR" type="text" class="form-control">
							<div class="input-group-addon">мм</div>
						</div>
					</div>
				</div>
